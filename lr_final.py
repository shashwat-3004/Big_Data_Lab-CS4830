...
Original file is located at
    https://colab.research.google.com/drive/1pDLnOj7I1CxiSp_kjkJHAMREg-iBdvEP
"""
...
test_data.write.json("gs://shapap2/yelp-test-final/test_yelp_dataset")
...
try:
    lr_model.save("gs://shapap2/LogReg_model_final")
except:
    model = lr_model.stages[2]
    print(model)
    model.save("gs://shapap2/LogReg_model_final")
...
print("Evaluating on Training data(F1-score)):", lr_evaluator_f1.evaluate(prediction_train))
